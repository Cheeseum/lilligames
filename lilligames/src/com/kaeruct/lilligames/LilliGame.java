...
import com.kaeruct.lilligames.screen.Screen;

public class LilliGame implements ApplicationListener {
	...
	public void setScreen(String name) {
		...
		name = "com.kaeruct.lilligames.screen." + name;  
		if (screen != null) screen.hide();
		
		if (!screens.containsKey(name)) {
			try {
				Class<?> screenClass =  Class.forName(name);   
	            Constructor<?> constructor = screenClass.getConstructor(LilliGame.class);      
